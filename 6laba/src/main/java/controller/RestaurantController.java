...
public class RestaurantController {
    ...
    public List<RestaurantResponseDTO> getAll() { return service.getAll(); }

    @GetMapping("/{id}")
    @Operation(summary = "Получить ресторан по ID")
    public RestaurantResponseDTO getById(@PathVariable Long id) { return service.getById(id); }

    @PostMapping
    @Operation(summary = "Добавить ресторан")
    public RestaurantResponseDTO create(@Valid @RequestBody RestaurantRequestDTO dto) { return service.create(dto); }
